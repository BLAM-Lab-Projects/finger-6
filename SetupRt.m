...
wrong_img = PobImage;
wrong_img.Add(1, 'original_matrix', {imcomplement(imread('misc/images/other/wrong.png'))}, ...
              'rel_x_pos', 0.2, ...
              'rel_y_pos', 0.5, ...
              'rel_x_scale', 0.15, ...
              'rel_y_scale', nan);
wrong_img.Add(2, 'original_matrix', {imcomplement(imread('misc/images/other/wrong.png'))}, ...
                'rel_x_pos', 0.8, ...
                'rel_y_pos', 0.5, ...
                'rel_x_scale', 0.15, ...
                'rel_y_scale', nan);
